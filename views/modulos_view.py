                            ...
                            controls=[
                                ...
                                ft.Column(
                                    controls=[
                                        ...
                                        ft.Text("Vocales: Bienvenido al primer módulo de aprendizaje. En esta sección conocerás y practicarás " \
                                        "las vocales de la Lengua de Señas Mexicana (A, E, I, O y U).", 
                                        size=8),
                                    ],
                                    expand=True,
                                )
